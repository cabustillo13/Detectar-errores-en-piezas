...
imagen = cv2.imread("./Imagenes/Fisuras/photo3.jpg")
#imagen = cv2.imread("./Imagenes/Produccion/photo3.jpg")
imagenc = imagen.copy()

# Imagen de referencia o patron a comparar
referencia = cv2.imread("./Imagenes/Fisuras/photo2.jpg")
#referencia = cv2.imread("./Imagenes/Produccion/photo0.jpg")
